...
export interface SushiBarInterface extends utils.Interface {
  functions: {
    ...
    "checkForStaked(uint256)": FunctionFragment;
    ...
    "releaseMyReward()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "checkForStaked",
  ...
  encodeFunctionData(
    functionFragment: "releaseMyReward",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SushiBar extends BaseContract {
  ...
  functions: {
    ...
    poolData(
      arg0: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[BigNumber, string] & { amount: BigNumber; referTo: string }>;
  ...
  callStatic: {
    ...
    releaseMyReward(overrides?: CallOverrides): Promise<void>;
